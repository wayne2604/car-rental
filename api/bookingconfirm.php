...
<nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="background-color: black; color: white;">
    ...
    <div class="container">
        <div class="jumbotron">
            <h1 class="text-center" style="color: #FFA500;"><span class="glyphicon glyphicon-ok-circle"></span> Booking Confirmed.</h1>
        </div>
    </div>
    <br>

    <h2 class="text-center" style="color: white;"> Thank you for using Car Rental Hub! We wish you have a safe ride. </h2>


 

    <h3 class="text-center" style="color: white;"> <strong>Your Order Number:</strong> <span style="color: #FFA500;"><?php echo "$id"; ?></span> </h3>



    <div class="container">
        <h5 class="text-center" style="color: white;">Please read the following information about your order.</h5>
        ...
        <div class="col-md-12" style="float: none; margin: 0 auto; text-align: center;">
             <h6 style="color: white;">Warning! <strong style="color: red;">Do not reload this page</strong> or the above display will be lost. If you want a hardcopy of this page, please print it now.</h6>
