...
?>
    ...
    <div class="col-md-7" style="float: none; margin: 0 auto;">
      <div class="form-area">
        ...
        <br style="clear: both">
          <h3 style="margin-bottom: 5px; text-align: center; font-size: 50px; color:black;"> Journey Details </h3>
          ...
          <input type="submit" name="submit" value="submit" class="btn btn-success pull-right" style="background-color: #FFA500; border-color: #FFA500;">
        </form>
      </div>
    </div>
