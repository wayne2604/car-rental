...
<body style="background-color: black;">
    ...
    <div class="col-md-7" style="float: none; margin: 0 auto;">
      <div class="form-area" style="background-color: black;  border: none;">
        ...
        <br style="clear: both">
        <h3 style="margin-bottom: 25px; text-align: center; color: white; font-size: 50px; font-weight:bold;"> CAR DETAILS </h3>
          ...
          <div class="form-group">
            <input type="text" class="form-control" id="ac_price" name="ac_price" placeholder="AC Fare per KM (Php)" required>
          </div>

          <div class="form-group">
            <input type="text" class="form-control" id="non_ac_price" name="non_ac_price" placeholder="Non-AC Fare per KM (Php)" required>
          </div>

          <div class="form-group">
            <input type="text" class="form-control" id="ac_price_per_day" name="ac_price_per_day" placeholder="AC Fare per day (Php)" required>
          </div>

          <div class="form-group">
            <input type="text" class="form-control" id="non_ac_price_per_day" name="non_ac_price_per_day" placeholder="Non-AC Fare per day (Php)" required>
          </div>

          <div class="form-group">
            <input name="uploadedimage" type="file" style="color: black;" >
          </div>
          <div class="form-group text-center"> <!-- Updated parent container -->
            <button type="submit" id="submit" name="submit" class="btn btn-warning" style="background-color: #FFA500; color:black; border-color: #FFA500;">Submit</button>
          </div>
        ...
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; color:white; font-size: 50px; font-weight:bold;"> VEHICLES </h3>
<?php
// Storing Session
