...
<div class="jumbotron" style="background-color: black; border: none;">
    <h1 class="text-center" style="color: #FFA500;"><span class="glyphicon glyphicon-ok-circle"></span> Car Returned</h1>
</div>
<h2 class="text-center" style="color: white;"> Thank you for visiting Car Rentals! We wish you have a safe ride. </h2>
