...
<div class="container" style="background-color: black; padding: 0; border: none; margin: 0;">
    <div class="jumbotron" style="text-align: center; background-color: black; border: none;">
		<h2 style="color: white;"> <?php echo "Welcome $customer_name!" ?> </h2>
		<h1 style="color: white;">Your account has been created.</h1>
		<p style="color: white;">Login Now from <a href="customerlogin.php" style="color: #FFA500;">HERE</a></p>
	</div>
</div>
